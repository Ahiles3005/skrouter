			...
			<div class="middle_info main_item_wrapper">
				...
				<div class="buy_block">
					...
					<?if(!$arResult["OFFERS"]):?>
						...
						<?= Aspro\Functions\CAsproOptimus::showItemCounter($arAddToBasketData, $arItemIDs, $arParams, $arResult, $arConfig); ?>
...
<?//char in separate tab?>
<?if($showProps && $arParams["PROPERTIES_DISPLAY_LOCATION"] == "TAB"):?>
	<?$this->SetViewTarget('PRODUCT_PROPS_INFO_TAB');?>
...
<?if($arVideo): ?>
	<?$this->SetViewTarget('VIDEO');?>
			<div class="title-tab-heading aspro-bcolor-0099cc visible-xs"><?=GetMessage("T_VIDEO");?></div>
...
<?endif;?>
<?//description?>
 <?if($arResult["DETAIL_TEXT"] || !empty($arFiles) || (is_array($arResult["STOCK"]) && $arResult["STOCK"]) || ($showProps && $arParams["PROPERTIES_DISPLAY_LOCATION"] != "TAB")):?>
	...
	<div>
		...
		<?endif;?>
			...
			<?if(!empty($arResult['SERVICES']) && $showProps):?>
