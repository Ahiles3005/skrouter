...
$arResult["SHOW_PROPERTIES"] = COptimus::PrepareItemProps($arResult["SHOW_PROPERTIES"]);
...
$arResult["SHOW_OFFER_PROPERTIES"] = COptimus::PrepareItemProps($arResult["SHOW_OFFER_PROPERTIES"]);
...
if ($arParams["USE_COMPARE_GROUP"] === "Y") {
	if ($arSectionsIDs){
		$arResult['SECTIONS'] = COptimusCache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => COptimusCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'GROUP' => array('ID'), 'MULTI' => 'N')), array('ID' => $arSectionsIDs, 'ACTIVE' => 'Y'), false, array("ID", "NAME", "IBLOCK_ID"));
	}
