...
<div class="catalog_detail" itemscope itemtype="http://schema.org/Product">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		Array(
			...
			"T_VIDEO" => ($arParams["TAB_DESCR_NAME_VIDEO"] ? $arParams["TAB_DESCR_NAME_VIDEO"] : GetMessage("T_VIDEO")),
			"T_PRODUCT_REVIEWS" => ($arParams["TAB_DESCR_NAME_PRODUCT_REVIEWS"] ? $arParams["TAB_DESCR_NAME_PRODUCT_REVIEWS"] : GetMessage("T_PRODUCT_REVIEWS")),
			"T_DESCRIPTION" => ($arParams["TAB_DESCR_NAME_DESCRIPTION"] ? $arParams["TAB_DESCR_NAME_DESCRIPTION"] : GetMessage("T_DESCRIPTION")),
			"T_PROPERTIES" => ($arParams["TAB_DESCR_NAME_PROPERTIES"] ? $arParams["TAB_DESCR_NAME_PROPERTIES"] : GetMessage("T_PROPERTIES")),
			"T_ASK" => ($arParams["TAB_DESCR_NAME_ASK"] ? $arParams["TAB_DESCR_NAME_ASK"] : GetMessage("T_ASK")),
			"T_STORES" => ($arParams["TAB_DESCR_NAME_STORES"] ? $arParams["TAB_DESCR_NAME_STORES"] : GetMessage("T_STORES")),
			"T_CUSTOM_TAB" => ($arParams["TAB_DESCR_NAME_CUSTOM_TAB"] ? $arParams["TAB_DESCR_NAME_CUSTOM_TAB"] : GetMessage("T_CUSTOM_TAB")),
			"T_OFFER_PRICES" => ($arParams["TAB_DESCR_NAME_OFFER_PRICES"] ? $arParams["TAB_DESCR_NAME_OFFER_PRICES"] : GetMessage("T_OFFER_PRICES")),
			
			"GIFTS_MAIN_PRODUCT_DETAIL_PAGE_ELEMENT_COUNT" => $arParams['GIFTS_MAIN_PRODUCT_DETAIL_PAGE_ELEMENT_COUNT'],
			"GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE" => $arParams['GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE'],
			"USE_DETAIL_PREDICTION" => $arParams["USE_DETAIL_PREDICTION"],
			"DETAIL_BLOCKS_ORDER" => $arParams["DETAIL_BLOCKS_ORDER"] ? $arParams["DETAIL_BLOCKS_ORDER"] : 'complect,nabor,tabs,gifts',
			"DETAIL_BLOCKS_TAB_ORDER" => $arParams["DETAIL_BLOCKS_TAB_ORDER"] ? $arParams["DETAIL_BLOCKS_TAB_ORDER"] : 'offer_prices,description,properties,video,product_reviews,ask,stores,custom_tab'
		),
		$component
	);?>
</div>
