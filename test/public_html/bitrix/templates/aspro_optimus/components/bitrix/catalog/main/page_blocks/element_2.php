...
<div class="catalog_detail el2" itemscope itemtype="http://schema.org/Product">
	<?$ElementID = $APPLICATION->IncludeComponent(
		...
		Array(
			...
			"DETAIL_BLOCKS_ALL_ORDER" => $arParams["DETAIL_BLOCKS_ALL_ORDER"] ? $arParams["DETAIL_BLOCKS_ALL_ORDER"] : 'offer_prices,complect,nabor,description,services,docs,video,product_reviews,ask,stores,custom_tab,gifts',
		),
		$component
	);?>
</div>
