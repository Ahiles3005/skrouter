...
<?		if (!is_array($arParams['INPUT_APPEARENCE'])): ?>
			<div class="afbf alx_feed_back 1 <? $arParams['INPUT_APPEARENCE'] != 'DEFAULT' ? strtolower($arParams['INPUT_APPEARENCE']) : '' ?>" id="alx_feed_back_<?=$ALX ?>">
<?		else: ?>
			<div class="afbf alx_feed_back 2 <? foreach ($arParams['INPUT_APPEARENCE'] as $param) if ($param != 'DEFAULT') echo strtolower($param) . ' ' ?>" id="alx_feed_back_<?=$ALX ?>">
<?		endif ?>
<?
?>
