    ...
    BX.ajax.post(
      ...
      BX.proxy(function (result) {
        ...
        if (typeof refresh !== undefined) {
          ...
          if (!$compareItems) {
            arOptimusOptions["COMPARE_ITEMS"] = [];
            $(".js-compare-block .count").text(arOptimusOptions["COMPARE_ITEMS"].length);
...
$(document).on("click", ".compare-sections__tab-item", function () {
  let th = $(this);
    ...
    $(".compare-sections__tab-item").removeClass("active cur");
    $(".compare-sections__item").removeClass("active");
    th.addClass("active cur");
    if (curSectionId) {
