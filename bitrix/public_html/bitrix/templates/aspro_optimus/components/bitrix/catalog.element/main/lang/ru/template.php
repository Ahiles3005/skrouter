<?
$MESS["ZAYAVKA"] = "Отправить заявку";
$MESS["RASSROCHKA"] = "В рассрочку";
$MESS["MY_SUCCESS"] = "Ваше сообщение успешно отправлено";
$MESS["ORM_NAME"] = "Ваше имя";
$MESS["ORM_PHONE"] = "Телефон";
$MESS["ORM_EMAIL"] = "Ваш e-mail";
$MESS["ORM_SOGL_1"] = "Я согласен на ";
$MESS["ORM_SOGL_2"] = "обработку персональных данных";
$MESS["ORM_SEND"] = "Отправить";
$MESS["ORM_SENDING"] = "Отправляем данные...";
$MESS["ORM_SENT"] = "Наш менеджер в ближайшее время свяжется с Вами!";
$MESS["ORM_Z"] = "Заявка на товар";
$MESS["ORM_R"] = "Заявка на рассрочку";
$MESS["MY_DELIVERY"] = "Доставка";
$MESS["MY_PAYMENT"] = "Оплата";
$MESS["MY_WARRANTY"] = "Гарантия";
$MESS["MY_VIDEO"] = "Видео";
