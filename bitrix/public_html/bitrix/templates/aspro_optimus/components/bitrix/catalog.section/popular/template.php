				...
				<div class="owl-carousel">
					<?foreach ($arResult['ITEMS'] as $arItem) {?>
						<div class="popular__item">
							...
							<a class="popular__name" href="<?=$arItem['DETAIL_PAGE_URL']?>"><?=$arItem['NAME']?></a>
							<div class="popular__price"><?=stristr($arItem['PROPERTIES']['MINIMUM_PRICE']['VALUE'], '.', 'true')?> <?=Loc::getMessage('RUB')?></div>
						</div>
					<?}?>
				</div>
			</div>
