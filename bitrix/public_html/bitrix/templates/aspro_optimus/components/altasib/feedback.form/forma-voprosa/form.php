...
<?		if($arParams["ADD_HREF_LINK"] != "N"):?>
			<input type="hidden" name="HREF_LINK_<?=$ALX?>" value="<?=$actionPage?>" />
<?		endif?>
...
<?		echo bitrix_sessid_post()?>
		<div class="afbf_submit_block">
			<input type="submit" class="fb_close afbf_btn" id="fb_close_<?=$ALX?>" name="SEND_FORM" value="<?=GetMessage('ALX_TP_MESSAGE_SUBMIT3')?>" />
		</div>
	</form>
</div>
