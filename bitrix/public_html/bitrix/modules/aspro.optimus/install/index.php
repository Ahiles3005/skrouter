...
class aspro_optimus extends CModule {
	...
	function InstallEvents(){
		...
		if(class_exists('\Bitrix\Main\EventManager')){
			...
			$eventManager->registerEventHandler('main', 'Bitrix\Main\Controller\LoadExt::onBeforeAction', $this->MODULE_ID, static::moduleClassEvents, 'OnBeforeAction');
		}
	...
	function UnInstallEvents(){
		...
		if(class_exists('\Bitrix\Main\EventManager')){
			...
			$eventManager->unregisterEventHandler('main', 'Bitrix\Main\Controller\LoadExt::onBeforeAction', $this->MODULE_ID, static::moduleClassEvents, 'OnBeforeAction');
		}
