...
<div class="item_main_info <?=(!$showCustomOffer ? "noffer" : "");?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>" id="<?=$arItemIDs["strMainID"];?>">
				...
				<div class="buy_block">
					...
					<?if(!$arResult["OFFERS"]):?>
						...
						<div class="counter_wrapp">
							...
							<?=Aspro\Functions\CAsproOptimus::showItemCounter($arAddToBasketData, $arItemIDs, $arParams, $arResult);?>
	...
	<?if($arParams["SHOW_KIT_PARTS"] == "Y" && $arResult["SET_ITEMS"]):?>
		...
		<?$this->EndViewTarget('PRODUCT_KIT_BLOCK');?>
	<?endif;?>
...
<?if($arResult["DETAIL_TEXT"] || $showProps):
	...
	<?$this->EndViewTarget('PRODUCT_DETAIL_TEXT_INFO');?>
<?endif;?>

<?//docs?>
<?if($arFiles):?>
	<?$this->SetViewTarget('FILES');?>
		<div class="drag_block">
			<div class="wrap_md wrap_md_row">
...
$templateData['SET_ITEMS'] = $arResult["SET_ITEMS"];
?>
