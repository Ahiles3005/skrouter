...
$MESS['OFFER_NOTE'] = "По умолчанию файл с публичной офертой находится в папке include. Не забудьте изменить текст с учетом данных вашей компании в файле «offer_detail.php»
...
$MESS['T_HEAD_FIXED_CHECK'] = "Отображать фиксированную шапку";
$MESS['T_HEAD_MOBILE_CHECK'] = "Отображать мобильную фиксированную шапку";

$MESS['T_MAP_TYPE'] = "Тип подключаемых карт";

$MESS['T_VIEW_TYPE_HIGHLOAD_PROP'] = "Отображать значение свойства типа «Справочник» при отсутствии картинки";

$MESS['T_CATALOG_PAGE_SECTIONS_TITLE'] = "Шаблон списка разделов каталога";
$MESS['T_CATALOG_PAGE_SECTIONS_1'] = "Списком";
$MESS['T_CATALOG_PAGE_SECTIONS_2'] = "Плиткой";

$MESS['T_CATALOG_PAGE_SUBSECTIONS_TITLE'] = "Шаблон списка подразделов каталога";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_1'] = "Списком";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_2'] = "Плиткой";
$MESS['T_CATALOG_PAGE_SUBSECTIONS_3'] = "Компактно";

$MESS['T_USE_COMPARE_GROUP'] = "Использовать группировку по разделам на странице сравнения";
