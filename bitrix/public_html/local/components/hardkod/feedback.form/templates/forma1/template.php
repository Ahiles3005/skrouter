...
<?if (!isset($arResult["POST"]))
{
	if ((!isset($arParams['ALX_GET_POPUP'.$ALX]) || $arParams['ALX_GET_POPUP'.$ALX]=='Y') && $arParams['ALX_LINK_POPUP'] == 'Y')
	{
		...
		<script type="text/javascript" src="<?= $this->__folder ?>/form_script.js"></script>
		<script type="text/javascript">
			...
			$(document).ready(function(){
				var param = {
					...
					'cssURL': ["<?=$this->__folder?>/form_style.css",
						...
						<?if ($arParams['ALX_RESET_THEME'] === 'Y'):?>
							"<?=$this->__folder?>/themes/default.css"
						<?else:?>
							"<?=$this->__folder?>/themes/theme_<?=md5($arParams['COLOR_THEME'].'_'.$arParams['COLOR_OTHER'].'_'.$arParams['COLOR_SCHEME'])?>.css"
						<?endif?>
					],
...
<?		if ($arParams['ALX_LINK_POPUP'] !== 'Y'):?>
		...
		<div class="alx-feedb-error"></div>
<?		endif?>
		<? $this->addExternalJs($this->GetFolder() . "/form_script.js"); ?>
		<? $this->addExternalCss($this->GetFolder() . "/form_style.css"); ?>
		<? if ($arParams['INPUT_APPEARENCE'] != 'DEFAULT' && !is_array($arParams['INPUT_APPEARENCE'])):?>
		...
		<? endif ?>
		<? if ($arParams['ALX_RESET_THEME'] === 'Y'):?>
			<? $this->addExternalCss($this->GetFolder() . "/themes/default.css") ?>
		<? else:?>
			<? $this->addExternalCss($this->GetFolder() . "/themes/theme_" . md5($arParams['COLOR_THEME'].'_'.$arParams['COLOR_OTHER'].'_'.$arParams['COLOR_SCHEME']) . ".css"); ?>
		<? endif ?>
...
#alx_feed_back_<?=$ALX?>.alx_feed_back{
	width:<? echo $arParams["WIDTH_FORM"]?>;
}
</style>
<?		endif;*/ ?>
<?	} ?>
